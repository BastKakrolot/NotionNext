...
export default function ArticleInfo(props) {
  ...
  return (
    <>
      <div className='flex flex-col h-[40vh] min-h-[300px] justify-center items-center gap-3 relative group'>
        {imgSrc && (
          <div className='w-full absolute z-[0] h-full overflow-hidden flex items-center transition-all'>
            <div className='brightness-[.2] h-full group-hover:brightness-[.25] w-full transition-all duration-500'>
              <LazyImage
                alt=''
