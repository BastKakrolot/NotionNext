...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'blackcell', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 鄂ICP备2021009860号', // 备案号 闽ICP备XXXXXXX
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email,facebook,twitter,telegram,messenger,line', // 分享的服務，按顺序显示,逗号隔开 //,reddit,whatsapp,linkedin
